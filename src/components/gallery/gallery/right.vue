...
<div class="main-content">
    <div class="img-list">
        <div class="cover"><img src="../img/0.png" alt=""></div>
        <div class="cover"><img src="../img/1.png" alt=""></div>
        <div class="cover"><img src="../img/2.png" alt=""></div>
    </div>
    <div class="img-list">
        <div class="cover"><img src="../img/0.png" alt=""></div>
        <div class="cover"><img src="../img/1.png" alt=""></div>
...
import fsgallert from '../js/jquery.mousewheel.min.js'
import a from '../js/pictureViewer'
import b from '../js/style'
export default {
	name: 'right'
}
</script>
...
<style>
.right{
	box-shadow:0px 0 12px darkgrey ;
	position: relative;
	margin-left:28%;
